...
## 📮 เริ่มทุก session ด้วยข้อนี้ก่อน (เพิ่ม 2026-07-31)

```bash
git pull
ls handoff/to-codex/        # กล่องของคุณ
```

- **มีข้อความ `blocking: true` ที่ยังไม่ตอบ → ตอบข้อนั้นก่อน ห้ามเริ่มงานอื่น**
- ตอบ = สร้างไฟล์ใหม่ใน `handoff/to-claude/` พร้อม `replies_to:` · **ห้ามแก้ไฟล์ในกล่อง `to-codex/`**
- กล่องว่าง → ไปดู [`docs/work-order.md`](docs/work-order.md) ตามปกติ

กฎเต็ม: [`handoff/README.md`](handoff/README.md)
