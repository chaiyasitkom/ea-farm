...
| ปล่อยให้มี hedge ภายในถ้ากลยุทธ์ต่างกันสั่งสวนกัน | เผา spread+swap 2 ขาเพื่อ net exposure = 0 · ทำให้ P3/P4 คำนวณเพี้ยน — ~~ถ้าอยากให้กลยุทธ์สวนกันได้ ให้ **แยกบัญชี** ไม่ใช่แยก magic~~ ⚠️ **ข้อความนี้ถูกยกเลิก 2026-07-30** โดย [ADR-005](ADR-005-cross-account-hedge.md): แยกบัญชีก็สวนกันไม่ได้ · P12 ห้ามทั้งฟาร์ม |
