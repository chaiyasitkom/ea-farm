...
| **D5** | 🟡 **จำนวนเงินปิดแล้ว: $30 × ≥2 บัญชี** — เหลือยืนยันว่าเป็น **cent account** · cent @ $30 = ผ่านครบ 6 คู่ lot 0.02–0.07 (R1 มี granularity จริงไม่ติดพื้น min lot) · standard @ $30 = reject ทุกไม้ ขาด 48× · **ไม่บล็อก SPEC-020/025 อีก** |
