...
- [ ] ★ **counter ต้องรีเซ็ตเมื่อกลับมาส่งได้** — ไม่งั้นช่วงพังรอบที่ 2 จะนับต่อจากรอบแรก
      แล้ว**บรรทัดแรกของช่วงใหม่อาจไม่ถูก log เลย** ซึ่งทำลายจุดประสงค์ของ throttle ทั้งข้อ
      · ค่าสะสมทั้ง session ให้เก็บแยกเป็นตัวที่สอง (`m_dropped_no_time_total`) สำหรับรายงานขึ้นสาย
